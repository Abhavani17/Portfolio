...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">bhavani.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">A.Bhavani</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> Bhavani
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="bhavani.docx" download>Download CV</a>
        </div>
        <div className="textcol">
          <img src="arava.jpg" alt="bhavani"/>
        </div>
      </div>
      <section id="aboutme" className="aboutme">
        <h1>About Me</h1>
        <p style={{ textAlign: 'justify' }}>I'm Arava Bhavani pursuing Bachelor of Technology in <span className="special">Annmacharaya institution of technology and sciences</span> in the stream of <span className="Special">&nbsp;Electrical and Electronics Engineering.</span> I am passionate about knowing</p>
        ...
        <ul>
          <li>From - jammalamadugu, India</li>
          <li>Lives in - jammalamadugu, India</li>
          <li>Age - 20</li>
          <li>Gender - Female</li>
        </ul>
      </section>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Girls High School, jammalamadugu</p>
              <p>I got 9.5 GPA in my School Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
          <div className="con rig">
            <img src="apms.jpg" alt="Diplomo Education" />
            <div className="text-box">
              <h2><span className="special">Electrical and Electronics Engineering</span></h2>
              <small>2019-2022</small>
              <p>I Completed my Diplomo Education at polytechnic College, Proddutur.</p>
              <p>I got 8.6 GPA in my Diplomo Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 9.1 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 21/163,<br /> teruroad,<br /> jammalamadugu,<br /> Kadapa(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="bhavaniarava17@gmail.com">bhavaniarava17@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 9390160199">9390160199</a></p>
            </div>
          </div>
